...
import { useCart } from "@/context/CartContext"; // ajuste o caminho para onde está seu contexto
...
const ProductClient: React.FC<Props> = ({ product, feature }) => {
  ...
  const { addItem } = useCart(); // <-- pegando do contexto
  ...
  const handleAddToCart = () => {
    addItem({
      id: product.id,
      name: product.name,
      price: finalUnitPrice, // já com desconto se tiver
      ...
      <div className="container mx-auto px-4 py-6 md:py-10">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2">
            <div className="rounded-2xl overflow-hidden bg-white shadow-sm border border-slate-200 relative">
              <img
