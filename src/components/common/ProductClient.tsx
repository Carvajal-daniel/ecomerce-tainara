...
const ProductClient: React.FC<Props> = ({ product, feature }) => {
  ...
  // Lógica de oferta segura com offer possivelmente null
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2 flex flex-col gap-6">
            ...
            <div className="flex gap-3">
              <button className="flex-1 inline-flex items-center justify-center gap-2 py-3 px-6 rounded-lg font-medium text-white bg-slate-900 hover:bg-slate-800 transition">
