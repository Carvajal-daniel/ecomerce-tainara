...
const SectionHeader = () => (
  <div className="text-center mb-4">
        {/* Title */}
        <div className="inline-flex items-center  gap-3 md:mb-4 mt-2">
...
const ProductsLancamentos = async () => {
  ...
  return (
    <section className="bg-gray-50 md:py-8 pt-4">
      <SectionHeader />
      <div className="relative max-w-screen-2xl px-3 md:px-6 lg:px-2 mx-auto">
        <Carousel opts={{ align: "start" }} className="w-full">
          ...
          <CarouselPrevious className="md:flex text-black md:-left-12 -left-2 hover:bg-white border-gray-200 hover:border-purple-300 p-5 transition-all duration-200 hover:shadow-lg" />
